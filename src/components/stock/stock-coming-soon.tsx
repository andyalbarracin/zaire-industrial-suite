// stock-coming-soon.tsx — src/components/stock/stock-coming-soon.tsx — 2026-07-18
// Placeholder de pantallas de Stock aún no construidas (se reemplaza en su fase).

import { Construction } from "lucide-react";

export function StockComingSoon({ title, desc, phase }: { title: string; desc: string; phase: string }) {
  return (
