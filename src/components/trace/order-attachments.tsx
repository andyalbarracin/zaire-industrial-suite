        ...
        return (
          <div key={sec.key} className="zaire-card p-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <label className={cn("inline-flex items-center gap-1.5 h-9 px-3 rounded-md text-sm font-medium cursor-pointer transition-colors", busy ? "bg-subtle-2 text-(--zaire-text-muted)" : "bg-zaire-navy-mid text-white hover:bg-zaire-navy")}>
